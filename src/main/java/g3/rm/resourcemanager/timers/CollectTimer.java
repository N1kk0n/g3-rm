...
public class CollectTimer extends TimerTask {
    ...
    private final Logger LOGGER = LogManager.getLogger("CollectTimer");
    ...
    @Override
    public void run() {
        LOGGER.info("Interrupting collect procedure. Task ID: " + taskId);

        Iterable<TaskProcess> processes = processRepository.findAllByEntityIdAndOperation(taskId, "COLLECT");
