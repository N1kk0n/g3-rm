...
public class CheckTask {
    ...
    public CompletableFuture<String> start() {
        ...
        responseService.setCheckInitEvent(taskObject.getTaskId(), taskObject.getSessionId());
        ...
        if (programParam == null) {
            ...
            responseService.setCheckDoneEvent(taskObject.getTaskId(), taskObject.getSessionId(), -1);
        ...
        responseService.setCheckDoneEvent(taskObject.getTaskId(), taskObject.getSessionId(), exitCode);
        if (exitCode != 0) {
            timerCreatorService.cancelTimer(timer);
            eventPublisher.publishTaskEvent(ERROR, taskObject);
            return CompletableFuture.completedFuture(ERROR);
